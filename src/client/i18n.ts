...
const zh = {
  ...
  'toolbar.fitViewHint': '适应视图 (F)',
  'toolbar.undo': '撤销',
  'toolbar.undoHint': '撤销 (Cmd/Ctrl+Z)',
  'toolbar.redo': '重做',
  'toolbar.redoHint': '重做 (Cmd/Ctrl+Shift+Z)',
  'toolbar.more': '更多',
  'group.view': '视图',
  'group.appearance': '外观',
  ...
  'toolbar.apply': '应用修改',
  'toolbar.edited': '已修改',
  'toolbar.approved': '已批准',
  'toolbar.map': '地图',
  'toolbar.interactive': '交互',
  'toolbar.theme': '主题',
  ...
  'diff.lockedNote': '当前 v{executing} 仍在执行；本次批准将保存为 v{next}，待当前执行结束后再交给 Agent。',
  'diff.cancel': '取消',
  'diff.submit': '提交修改',
  'diff.submitting': '提交中…',
...
export const visualPlanEn: Record<VisualPlanKey, string> = {
  ...
  'toolbar.fitViewHint': 'Fit View (F)',
  'toolbar.undo': 'Undo',
  'toolbar.undoHint': 'Undo (Cmd/Ctrl+Z)',
  'toolbar.redo': 'Redo',
  'toolbar.redoHint': 'Redo (Cmd/Ctrl+Shift+Z)',
  'toolbar.more': 'More',
  'group.view': 'View',
  ...
  'toolbar.approved': 'Approved',
  'toolbar.map': 'Map',
  'toolbar.interactive': 'Interactive',
  'toolbar.theme': 'Theme',
  ...
  'diff.lockedNote': 'Plan v{executing} is still executing; this approval will be saved as v{next} and handed to the agent after it completes.',
  'diff.cancel': 'Cancel',
